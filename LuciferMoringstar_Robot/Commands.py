    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**Please Join My Index Bots Channel to use this Bot!**",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("📢 Join Index Bots Channel 📢", url=invite_link.invite_link)
                            ],
                            [
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🎖 WikiLeaks Index Bots 🎖', url=f'{TUTORIAL}')
                    ]
                    ]
